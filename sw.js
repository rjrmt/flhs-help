...
const CACHE_NAME = "flhs-help-shell-v106";
...
const SHELL_URLS = [
  ...
  "./pages/teacher-directory.html",
  "./pages/it-resources.html",
  "./pages/upload.html",
  "./pages/media.html",
  ...
  "./pages/laptop-count.html",
  "./pages/teacher-laptop.html",
  ...
  "./js/coupons-hub.js",
  "./js/coupons-print.js",
  "./js/coupons-builder.js",
  "./js/coupons-quick-print.js",
  "./js/coupons-settings.js",
  "./css/coupons.css",
  "./css/laptop-needs.css",
